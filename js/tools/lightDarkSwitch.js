...
=======
import{main}from"../main.js";let elementCode=".mermaid",saveOriginalData=function(){return new Promise((t,i)=>{try{var e=document.querySelectorAll(elementCode),a=e.length;e.forEach(e=>{e.setAttribute("data-original-code",e.innerHTML),0==--a&&t()})}catch(e){i(e)}})},resetProcessed=function(){return new Promise((t,i)=>{try{var e=document.querySelectorAll(elementCode),a=e.length;e.forEach(e=>{null!=e.getAttribute("data-original-code")&&(e.removeAttribute("data-processed"),e.innerHTML=e.getAttribute("data-original-code")),0==--a&&t()})}catch(e){i(e)}})},ModeToggle={modeToggleButton_dom:null,iconDom:null,mermaidLightTheme:null,mermaidDarkTheme:null,async mermaidInit(e){window.mermaid&&(await resetProcessed(),mermaid.initialize({theme:e}),mermaid.init({theme:e},document.querySelectorAll(elementCode)))},enableLightMode(){document.body.classList.remove("dark-mode"),document.documentElement.classList.remove("dark"),document.body.classList.add("light-mode"),document.documentElement.classList.add("light"),this.iconDom.className="fa-regular fa-moon",main.styleStatus.isDark=!1,main.setStyleStatus(),this.mermaidInit(this.mermaidLightTheme),this.setGiscusTheme()},enableDarkMode(){document.body.classList.remove("light-mode"),document.documentElement.classList.remove("light"),document.body.classList.add("dark-mode"),document.documentElement.classList.add("dark"),this.iconDom.className="fa-regular fa-brightness",main.styleStatus.isDark=!0,main.setStyleStatus(),this.mermaidInit(this.mermaidDarkTheme),this.setGiscusTheme()},async setGiscusTheme(t){if(document.querySelector("#giscus-container")){let e=document.querySelector("iframe.giscus-frame");for(;!e;)await new Promise(e=>setTimeout(e,1e3)),e=document.querySelector("iframe.giscus-frame");for(;e.classList.contains("giscus-frame--loading");)await new Promise(e=>setTimeout(e,1e3));t??=main.styleStatus.isDark?"dark":"light",e.contentWindow.postMessage({giscus:{setConfig:{theme:t}}},"https://giscus.app")}},isDarkPrefersColorScheme(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)")},initModeStatus(){var e=main.getStyleStatus();e?e.isDark?this.enableDarkMode():this.enableLightMode():this.isDarkPrefersColorScheme().matches?this.enableDarkMode():this.enableLightMode()},initModeToggleButton(){this.modeToggleButton_dom.addEventListener("click",()=>{document.body.classList.contains("dark-mode")?this.enableLightMode():this.enableDarkMode()})},initModeAutoTrigger(){this.isDarkPrefersColorScheme().addEventListener("change",e=>{e.matches?this.enableDarkMode():this.enableLightMode()})},async init(){this.modeToggleButton_dom=document.querySelector(".tool-dark-light-toggle"),this.iconDom=document.querySelector(".tool-dark-light-toggle i"),this.mermaidLightTheme=void 0!==theme.mermaid&&void 0!==theme.mermaid.style&&void 0!==theme.mermaid.style.light?theme.mermaid.style.light:"default",this.mermaidDarkTheme=void 0!==theme.mermaid&&void 0!==theme.mermaid.style&&void 0!==theme.mermaid.style.dark?theme.mermaid.style.dark:"dark",this.initModeStatus(),this.initModeToggleButton(),this.initModeAutoTrigger();try{await saveOriginalData().catch(console.error)}catch(e){}}};export default function initModeToggle(){ModeToggle.init()}export{ModeToggle};
>>>>>>> main1
